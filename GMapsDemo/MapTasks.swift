    ...
    func geocodeAddress(_ address: String!, withCompletionHandler completionHandler: @escaping ((_ status: String, _ success: Bool) -> Void)) {
        if let lookupAddress = address {
            ...
            DispatchQueue.main.async(execute: { () -> Void in
                ...
                var error: NSError?
                let dictionary: Dictionary<NSObject, AnyObject> = JSONSerialization.JSONObjectWithData(geocodingResultsData!, options: JSONSerialization.ReadingOptions.MutableContainers) as! Dictionary<NSObject, AnyObject>
