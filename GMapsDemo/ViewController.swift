...
class ViewController: UIViewController, CLLocationManagerDelegate, GMSMapViewDelegate {
    ...
    func recreateRoute() {
        if let polyline = routePolyline {
            ...
            mapTasks.baseURLDirections(mapTasks.originAddress, destination: mapTasks.destinationAddress, waypoints: waypointsArray, travelMode: travelMode, completionHandler: { (status, success) -> Void in
